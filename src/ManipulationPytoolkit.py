...
class ManipulationPytoolkit:
    ...
    def callbackGoToActionPytoolkit(self, req):
        ...
        if(name=="place_both_arms"):
            ...
            # Giras brazo
            angle_1 = [0.522444, 0.00885305, -1.39163, -0.517197, 1.57039, 1.57468, -0.00886001, 1.56703, 0.00884139, 0.230022, 1.0, 0.5]

            # Bajas brazo
            angle_2 = [0.796827, 0.00881551, -1.39942, -0.525606, 1.39701, 1.5746, -0.00885075, 1.56701, 0.00882722, 0.230255, 1.0, 0.5]
            ...
            # Giras brazo
            angle_1 = [1.56705, 0.0087755, -1.57479, -0.00876018, -0.00327626, 0.529962, -0.00886489, 1.39943, 0.531231, -2.174, 0.5, 1.0]
